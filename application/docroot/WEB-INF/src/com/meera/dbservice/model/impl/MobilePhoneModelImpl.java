...
/**
 * The base model implementation for the MobilePhone service. Represents a row in the &quot;LS_MobilePhone&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class MobilePhoneModelImpl extends BaseModelImpl<MobilePhone>
	 ...
	 */
	public static final String TABLE_NAME = "LS_MobilePhone";
	...
	public static final String TABLE_SQL_CREATE = "create table LS_MobilePhone (mobilePhoneId LONG not null primary key,name VARCHAR(75) null,brand VARCHAR(75) null,description VARCHAR(75) null,releaseDate DATE null,price DOUBLE)";
	public static final String TABLE_SQL_DROP = "drop table LS_MobilePhone";
	public static final String ORDER_BY_JPQL = " ORDER BY mobilePhone.mobilePhoneId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY LS_MobilePhone.mobilePhoneId ASC";
