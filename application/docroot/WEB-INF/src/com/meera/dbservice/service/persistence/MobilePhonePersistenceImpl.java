...
import com.meera.dbservice.NoSuchMobilePhoneException;
import com.meera.dbservice.model.MobilePhone;
import com.meera.dbservice.model.impl.MobilePhoneImpl;
import com.meera.dbservice.model.impl.MobilePhoneModelImpl;
...
public class MobilePhonePersistenceImpl extends BasePersistenceImpl<MobilePhone>
	 ...
	 */
	@Override
	public MobilePhone create(long mobilePhoneId) {
		MobilePhone mobilePhone = new MobilePhoneImpl();

		mobilePhone.setNew(true);
		mobilePhone.setPrimaryKey(mobilePhoneId);
	 ...
	 */
	@Override
	public MobilePhone remove(long mobilePhoneId)
		throws NoSuchMobilePhoneException, SystemException {
		return remove((Serializable)mobilePhoneId);
	}
	...
	protected MobilePhone toUnwrappedModel(MobilePhone mobilePhone) {
		...
		mobilePhoneImpl.setMobilePhoneId(mobilePhone.getMobilePhoneId());
	 ...
	 */
	@Override
	public MobilePhone findByPrimaryKey(long mobilePhoneId)
		throws NoSuchMobilePhoneException, SystemException {
		return findByPrimaryKey((Serializable)mobilePhoneId);
	}
	 ...
	 */
	@Override
	public MobilePhone fetchByPrimaryKey(long mobilePhoneId)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)mobilePhoneId);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.meera.dbservice.model.MobilePhone")));
